...
export default class PanelCollapser extends Base.mixin(Factoryable) {
    ...
    static get configurable() {
        return {
             ...
             * @config {ToolConfig|Core.widget.Tool|null}
             */
            tool : {
                type : 'collapsetool',
    ...
    applyHeaderDock(collapsed, flush = true) {
        ...
        if (dock !== currentDock && panel.hasHeader) {
            panel.header = header ? typeof header === 'string' ? { title : header } : ObjectHelper.clone(panel.header) : {};
            panel.header.dock = dock;
