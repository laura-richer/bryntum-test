...
const locale = {
    ...
    EmptyCalendarEffectDescription : {
        ...
        forwardDescriptionTpl        : 'A tarefa "{2}" não pode ser executada. A agenda "{0}" não tem horário de funcionamento depois de {1}.',
        backwardDescriptionTpl       : 'A tarefa "{2}" não pode ser executada. A agenda "{0}" não tem horário de funcionamento antes de {1}.',
        noIntersectionDescriptionTpl : 'A tarefa "{2}" não pode ser executada. Sua agenda "{0}" e suas agendas de recursos não têm horário de trabalho comum.'
    },
    ...
    HonorProjectConstraintResolution : {
        descriptionTpl : 'Ajuste a tarefa para respeitar a borda do projeto.'
    },

    IgnoreResourceCalendarEmptyCalendarEffectResolution : {
        descriptionTpl : 'Ignore calendários de recursos e agende a tarefa usando apenas seu próprio calendário.'
    },
