...
import { ChronoPartOfProjectModelMixin } from "../../model/mixin/ChronoPartOfProjectModelMixin.js"
...
>) => {
    ...
    class ChronoPartOfProjectStoreMixin extends base {
        modelClass          : typeof ChronoPartOfProjectModelMixin
        ...
        joinRecordsToProject (project : this['project'], skipRoot = false) {
        ...
        unjoinRecordsFromProject (project : this['project']) {
            ...
            if (rootNode) {
                (rootNode as ChronoPartOfProjectModelMixin).traverse(node => {
        ...
        // Map of record updates of which should be tracked
        recordsToTrackChanges : Map<ChronoModelMixin, boolean>

        detachRecordChangeTracker : Function
        ...
        trackRecordFieldChanges (record : ChronoModelMixin, fieldName : string) {
        ...
        untrackRecordFieldChanges (record : ChronoModelMixin, fieldName : string = undefined) {
        ...
        // A special identifier that gets changed when the store gets filtered
        $filtered : Identifier
