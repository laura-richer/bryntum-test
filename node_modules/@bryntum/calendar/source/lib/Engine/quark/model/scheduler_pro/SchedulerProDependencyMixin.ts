...
export class SchedulerProDependencyMixin extends Mixin(
    ...
    class SchedulerProDependencyMixin extends base {
        ...
        fromEvent           : HasDependenciesMixin & ConstrainedEarlyEventMixin
        toEvent             : HasDependenciesMixin & ConstrainedEarlyEventMixin
        ...
        /**
         * Converts lag value from one time unit to another
         * @param duration Duration value
         * @param fromUnit Duration value time unit
         * @param toUnit   Target time unit to convert the value to
         */
        * convertLagGen (lag : Duration, fromUnit : TimeUnit, toUnit : TimeUnit) : CalculationIterator<Duration> {
            return yield* this.getDurationConverter().$convertDuration(lag, fromUnit, toUnit)
        }
        ...
        * calculateCalendar () : CalculationIterator<BaseCalendarMixin> {
            ...
            switch (dependenciesCalendar) {
                case DependenciesCalendar.Project:
                    ...
                    break
                case DependenciesCalendar.AllWorking:
                    calendar            = yield project.$.defaultCalendar
                    break
