...
const locale = {
    ...
    EmptyCalendarEffectDescription: {
        descriptionTpl: '"{2}" ülesannet ei saa täita. "{0}" Kalender ei anna tööaja intervalle.',
        forwardDescriptionTpl: '"{2}" ülesannet ei saa täita. "{0}" Kalendril puudub tööaeg pärast {1}.',
        backwardDescriptionTpl: '"{2}" ülesannet ei saa täita. "{0}" Kalendril pole enne {1} tööaega.',
        noIntersectionDescriptionTpl: '"{2}" ülesannet ei saa täita. Selle "{0}" kalendril ja ressursikalendritel pole ühist tööaega.'
    },
    ...
    IgnoreResourceCalendarEmptyCalendarEffectResolution: {
        descriptionTpl: 'Ignoreerige ressursikalendreid ja kavandage ülesanne ainult oma kalendriga.'
    },
    ...
    PostponeDateConstraintConflictResolution: {
        descriptionTpl: 'Lükka lahendamine edasi ja märgi ülesanne "{0}" konfliktimarkeriga'
    }
};
