...
export default Target => class Factoryable extends (Target || Base) {
     ...
     * @internal
     */
    static register(type, cls, replace = globalThis.__BRYNTUM_EXAMPLE || globalThis.DocsBrowser?.isDocsBrowser) {
    ...
    static isType(instance, type, deep) {
        ...
        return typeCls ? (deep ? (instance instanceof typeCls) : (instance.constructor === typeCls)) : false;
    }
    ...
    static setupType(cls, meta) {
        ...
        defineProperty(cls.prototype, 'type', {
            ...
            set : value => {
                if (value !== type) {
                    throw new Error('Can not mutate `type` config to different value');
                }
            }
        });
    }
