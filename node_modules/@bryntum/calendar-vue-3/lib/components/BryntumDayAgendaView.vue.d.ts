import type { ActionButtonsConfig, AlignSpec, Base, BryntumScrollOptions, ButtonConfig, CalendarMixin, CalendarRow, CalendarRowConfig, Container, ContainerItemConfig, ContainerLayoutConfig, DayAgendaViewListeners, DayCell, DayView, DomConfig, DurationConfig, EventBar, EventModel, KeyMapConfig, MaskConfig, MenuItemConfig, Model, OverflowPopupConfig, PagingToolbarConfig, Panel, PanelCollapserConfig, PanelCollapserOverlayConfig, PanelHeader, Rectangle, ResourceModel, Scroller, ScrollerConfig, StateProvider, TabConfig, Tool, ToolConfig, ToolbarConfig, ToolbarItems, TooltipConfig, Widget } from '@bryntum/calendar';
import { DayAgendaView } from '@bryntum/calendar';
declare const _default: import("vue").DefineComponent<__VLS_TypePropsToRuntimeProps<{
     ...
     */
    actionButtons?: ActionButtonsConfig[] | Record<string, ActionButtonsConfig> | undefined;
    /**
     ...
     */
    allDayEvents?: CalendarRow | CalendarRowConfig | null | undefined;
    /**
     ...
     */
    allowZoomUnderflow?: Boolean | undefined;
    /**
     ...
     */
    columnHeaderRenderer?: string | ((cellData: DayCell) => string | object) | undefined;
     ...
     * @returns {object[]}
     */
    coreHours?: string | object | ((date: Date) => object[]) | undefined;
    /**
     ...
     */
    currentTimeIndicatorRenderer?: string | (() => DomConfig) | undefined;
    /**
     ...
     */
    dashedSubticks?: Boolean | undefined;
    /**
     ...
     * @returns {string}
     */
    dayCellRenderer?: string | ((domConfig: {
        className: object;
        style: object;
        dataset: object;
    }, children: DomConfig[], cellData: DayCell) => string) | undefined;
    /**
     ...
     */
    dayEndTime?: string | number | undefined;
    /**
     * A function, or name of a function which is passed the [DomConfig](https://bryntum.com/products/calendar/docs/api/Core/helper/DomHelper#typedef-DomConfig) object which
     ...
     * @returns {string}
     */
    dayHeaderRenderer?: string | ((headerDomConfig: {
        className: object;
        style: object;
        dataset: object;
        children: DomConfig[];
    }, cellData: DayCell) => string) | undefined;
    /**
     ...
     */
    dayStartShift?: string | number | undefined;
    /**
     ...
     */
    dayStartTime?: string | number | undefined;
    /**
     ...
     */
    eventFlowDirection?: "column" | "row" | undefined;
    /**
     ...
     */
    eventSpacing?: string | number | undefined;
    /**
     ...
     */
    gutterWidth?: string | number | undefined;
    /**
     ...
     */
    hideEmptyHours?: Boolean | undefined;
    /**
     ...
     */
    hourHeightBreakpoints?: number[] | undefined;
    /**
     * How much vertical whitespace between the hour cells.
     */
    hourSpacing?: string | number | undefined;
    /**
     ...
     */
    interDayDrag?: Boolean | undefined;
    /**
     ...
     */
    interDayResize?: Boolean | undefined;
    /**
     ...
     */
    listeners?: DayAgendaViewListeners | undefined;
    /**
     ...
     */
    maxAllDayHeight?: string | number | undefined;
    /**
     ...
     */
    minDayWidth?: string | number | undefined;
    /**
     ...
     */
    minEventHeight?: string | number | undefined;
    /**
     ...
     */
    minEventWidth?: string | number | undefined;
    /**
     ...
     */
    minHourHeight?: number | undefined;
    /**
     ...
     */
    noMatchingDates?: string | DomConfig | undefined;
    /**
     ...
     */
    showAllDayHeader?: Boolean | undefined;
    /**
     * *Only valid if this Widget is [floating](https://bryntum.com/products/calendar/docs/api/Core/widget/Widget#config-floating).*
     * ...
     ...
     */
    showTime?: Boolean | Record<"startTime" | "endTime", Boolean> | undefined;
    /**
     ...
     */
    syncHourHeights?: Boolean | undefined;
    /**
     ...
     */
    tickRenderer?: string | ((tickContext: {
        startTime: Date;
        endTime: Date;
        events: EventModel[];
        tickIndex: number;
     ...
     */
    timeAxisTimeFormat?: string | undefined;
    /**
     ...
     */
    visibleStartTime?: string | number | null | undefined;
    /**
    ...
    layoutUpdate: (params: string | ((event: {
        source: DayView;
    }) => void)) => void;
    ...
    rangeChange: (params: string | ((event: {
        source: <T_1 extends import("@bryntum/calendar").AnyConstructor<Base>>(base: T_1) => import("@bryntum/calendar").AnyConstructor<InstanceType<T_1> & import("@bryntum/calendar").DateRangeOwnerClass>;
        old: {
            startDate: Date;
            endDate: Date;
        };
    ...
    tickChange: (params: string | ((event: {
        old: {
            level: number;
            step: string;
        };
    ...
    onLayoutUpdate?: ((params: string | ((event: {
        source: DayView;
    }) => void)) => any) | undefined;
    onTickChange?: ((params: string | ((event: {
        old: {
            level: number;
            step: string;
        };
