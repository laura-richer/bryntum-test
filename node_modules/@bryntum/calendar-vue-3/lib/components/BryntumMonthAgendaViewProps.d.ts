import type { AgendaView, AgendaViewConfig, AlignSpec, Base, BryntumScrollOptions, ButtonConfig, CalendarMixin, CalendarPanel, ContainerItemConfig, ContainerLayoutConfig, DayAgendaView, DayAgendaViewConfig, DayView, DayViewConfig, DomConfig, DurationConfig, EventBar, EventModel, EventStore, KeyMapConfig, MaskConfig, MenuItemConfig, Month, MonthAgendaViewListeners, MonthConfig, PagingToolbarConfig, PanelCollapserConfig, PanelCollapserOverlayConfig, PanelHeader, Rectangle, ResourceModel, Scroller, ScrollerConfig, StateProvider, TabConfig, ToolConfig, ToolbarConfig, ToolbarItems, TooltipConfig, Widget } from '@bryntum/calendar';
export declare type BryntumMonthAgendaViewProps = {
    /**
     ...
     */
    agenda?: AgendaViewConfig | DayViewConfig | DayAgendaViewConfig | {
        type: 'agendaview' | 'dayview' | 'dayagenda';
    } | AgendaView | DayView | DayAgendaView;
    /**
