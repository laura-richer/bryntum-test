...
export default class SchedulerExportDialog extends GridExportDialog {
    ...
    static $name = 'SchedulerExportDialog';

    static type = 'schedulerexportdialog';
                ...
                rangesContainer : {
                    ...
                    items : {
                        ...
                        rangeStartField : {
                            ...
                            weight     : 10,
                            onChange({ value }) {
                                this.parent.widgetMap.rangeEndField.min = value ? DateHelper.add(value, 1, 'd') : null;
                            }
                        },
                        rangeEndField : {
                            type       : 'datefield',
                            ...
                            weight     : 30,
                            onChange({ value }) {
                                this.parent.widgetMap.rangeStartField.max = value ? DateHelper.add(value, -1, 'd') : null;
                            }
                        }
                    }
                }
    ...
    applyInitialValues(config) {
        ...
        filler.width = me.L('L{labelWidth}');
