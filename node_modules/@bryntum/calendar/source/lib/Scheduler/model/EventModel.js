 ...
 *
 * It is a subclass of the {@link Scheduler.model.TimeSpan}, which is in turn a subclass of {@link Core.data.Model}.
 * Please refer to the documentation of that class to become familiar with the base interface of the event.
 *
 * ## Recurrence
 *
 * This class mixes {@link Scheduler/model/mixin/RecurringTimeSpan} which provides recurrence support. Using the
 * {@link Scheduler/model/mixin/RecurringTimeSpan#field-recurrenceRule} and
 * {@link Scheduler/model/mixin/RecurringTimeSpan#field-exceptionDates} you can express just about any recurrence
 * pattern. Below is the data for a repeating event happening every weekday at 10am.
 *
 * ```json
 * {
 *   "id"             : 1,
