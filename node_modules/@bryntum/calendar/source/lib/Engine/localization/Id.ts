...
const locale = {
    ...
    EmptyCalendarEffectDescription : {
        descriptionTpl               : 'Tugas "{2}" tidak dapat dilakukan. Kalender "{0}" tidak memberikan interval waktu kerja.',
        forwardDescriptionTpl        : 'Tugas "{2}" tidak dapat dilakukan. Kalender "{0}" tidak memiliki waktu kerja setelah {1}.',
        backwardDescriptionTpl       : 'Tugas "{2}" tidak dapat dilakukan. Kalender "{0}" tidak memiliki waktu kerja sebelum {1}.',
        noIntersectionDescriptionTpl : 'Tugas "{2}" tidak dapat dilakukan. Kalender "{0}" dan kalender sumber daya tidak memiliki waktu kerja yang sama.'
    },
    ...
    IgnoreResourceCalendarEmptyCalendarEffectResolution : {
        descriptionTpl : 'Abaikan kalender sumber daya dan jadwalkan tugas dengan kalender sendiri saja.'
    },
    ...
    PostponeDateConstraintConflictResolution : {
        descriptionTpl : 'Tunda penyelesaian dan tandai tugas "{0}" dengan penanda konflik'
    }
}
