import type { AlignSpec, Base, BryntumScrollOptions, ButtonConfig, CalendarMixin, ContainerItemConfig, ContainerLayoutConfig, DomConfig, DurationConfig, EventBar, EventModel, KeyMapConfig, MaskConfig, MenuItemConfig, PagingToolbarConfig, PanelCollapserConfig, PanelCollapserOverlayConfig, PanelHeader, Rectangle, ResourceModel, ResourceViewListeners, Scroller, ScrollerConfig, StateProvider, TabConfig, ToolConfig, ToolbarConfig, ToolbarItems, TooltipConfig, Widget } from '@bryntum/calendar';
export declare type BryntumResourceViewProps = {
    /**
     ...
     */
    view?: ContainerItemConfig | Record<string, any>;
    /**
