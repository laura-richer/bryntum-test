...
const locale = {
    ...
    EmptyCalendarEffectDescription: {
        descriptionTpl: 'งาน "{2}" ไม่สามารถทำได้ ปฏิทิน "{0}" ไม่ได้ให้ช่วงเวลาการทำงานใด ๆ',
        forwardDescriptionTpl: 'งาน "{2}" ไม่สามารถทำได้ ปฏิทิน "{0}" ไม่มีเวลาทำงานหลังจาก {1}',
        backwardDescriptionTpl: 'งาน "{2}" ไม่สามารถทำได้ ปฏิทิน "{0}" ไม่มีเวลาทำงานก่อน {1}',
        noIntersectionDescriptionTpl: 'งาน "{2}" ไม่สามารถทำได้ ปฏิทิน "{0}" และปฏิทินทรัพยากรไม่มีเวลาทำงานร่วมกัน'
    },
    ...
    IgnoreResourceCalendarEmptyCalendarEffectResolution: {
        descriptionTpl: 'ละเว้นปฏิทินทรัพยากรและกำหนดเวลางานด้วยปฏิทินของตัวเองเท่านั้น'
    },
    ...
    PostponeDateConstraintConflictResolution: {
        descriptionTpl: 'เลื่อนการแก้ปัญหาและแฟล็กงาน "{0}" ด้วยเครื่องหมายข้อขัดแย้ง'
    }
};
