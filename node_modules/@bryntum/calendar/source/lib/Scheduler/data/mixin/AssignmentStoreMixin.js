...
export default Target => class AssignmentStoreMixin extends Target {
    static $name = 'AssignmentStoreMixin';
    ...
    setStoreData(data) {
        if (this.usesSingleAssignment) {
            throw new Error('Data loading into AssignmentStore (multi-assignment mode) cannot be combined with EventStore data containing resourceId (single-assignment mode)');
        }
    ...
    // Proper types are documented for each product in their AssignmentStore.js file
