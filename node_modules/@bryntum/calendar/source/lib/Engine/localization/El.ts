...
const locale = {
    ...
    EmptyCalendarEffectDescription : {
        descriptionTpl               : '"{2}" Δεν είναι δυνατή η εκτέλεση της εργασίας. "{0}" Ημερολόγιο δεν παρέχει χρονικά διαστήματα εργασίας.',
        forwardDescriptionTpl        : '"{2}" Δεν είναι δυνατή η εκτέλεση της εργασίας. "{0}" Ημερολόγιο δεν έχει χρόνο εργασίας μετά το {1}.',
        backwardDescriptionTpl       : '"{2}" Δεν είναι δυνατή η εκτέλεση της εργασίας. "{0}" Ημερολόγιο δεν έχει χρόνο εργασίας πριν {1}.',
        noIntersectionDescriptionTpl : '"{2}" Δεν είναι δυνατή η εκτέλεση της εργασίας. Το ημερολόγιο του "{0}" και τα ημερολόγια πόρων του δεν έχουν κοινό χρόνο εργασίας.'
    },
    ...
    IgnoreResourceCalendarEmptyCalendarEffectResolution : {
        descriptionTpl : 'Αγνοήστε τα ημερολόγια πόρων και προγραμματίστε την εργασία μόνο με το δικό του ημερολόγιο.'
    },
    ...
    PostponeDateConstraintConflictResolution : {
        descriptionTpl : 'Αναβάλετε την επίλυση και επισημάνετε την εργασία "{0}" με δείκτη διένεξης'
    }
}
