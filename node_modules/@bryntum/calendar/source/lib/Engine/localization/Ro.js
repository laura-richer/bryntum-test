...
const locale = {
    ...
    EmptyCalendarEffectDescription: {
        descriptionTpl: 'Sarcina „{2}” nu poate fi efectuată. Calendarul "{0}" nu oferă intervale de timp de lucru.',
        forwardDescriptionTpl: 'Sarcina „{2}” nu poate fi efectuată. „{0}” Calendarul nu are timp de lucru după {1}.',
        backwardDescriptionTpl: 'Sarcina „{2}” nu poate fi efectuată. „{0}” Calendarul nu are timp de lucru înainte de {1}.',
        noIntersectionDescriptionTpl: 'Sarcina „{2}” nu poate fi efectuată. Calendarul său „{0}” și calendarele sale de resurse nu au un timp de lucru comun.'
    },
    ...
    IgnoreResourceCalendarEmptyCalendarEffectResolution: {
        descriptionTpl: 'Ignorați calendarele de resurse și programați -vă sarcina doar cu propriul calendar.'
    },
    ...
    PostponeDateConstraintConflictResolution: {
        descriptionTpl: 'Amânați rezolvarea și semnalați sarcina "{0}" cu marcatorul de conflict'
    }
};
