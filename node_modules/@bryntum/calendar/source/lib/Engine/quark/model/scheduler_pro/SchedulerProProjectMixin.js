...
import { DependenciesCalendar, DependencyValidationResult, ProjectType, StartedTaskScheduling } from "../../../scheduling/Types.js";
...
import { DeactivateDependencyResolution, DependencyConstraintInterval, RemoveDependencyResolution } from "./ConstrainedByDependenciesEventMixin.js";
...
export class SchedulerProProjectMixin extends Mixin([SchedulerBasicProjectMixin, ConstrainedEarlyEventMixin, HasChildrenMixin], (base) => {
    ...
    SchedulerProProjectMixin.$name = 'SchedulerProProjectMixin';
    __decorate([
    ...
    ], SchedulerProProjectMixin.prototype, "startedTaskScheduling", void 0);
    __decorate([
        model_field({ type: 'boolean', defaultValue: true })
    ], SchedulerProProjectMixin.prototype, "addConstraintOnDateSet", void 0);
    __decorate([
        model_field({ type: 'boolean', defaultValue: true })
    ], SchedulerProProjectMixin.prototype, "autoScheduleManualTasksOnSecondPass", void 0);
    __decorate([
        model_field({ type: 'boolean', defaultValue: false })
    ], SchedulerProProjectMixin.prototype, "allowPostponedConflicts", void 0);
    __decorate([
        model_field({ type: 'boolean', defaultValue: false })
    ], SchedulerProProjectMixin.prototype, "autoPostponedConflicts", void 0);
    __decorate([
        model_field({ type: 'boolean', defaultValue: true })
    ], SchedulerProProjectMixin.prototype, "autoMergeAdjacentSegments", void 0);
...
DeactivateDependencyCycleEffectResolution.$name = 'DeactivateDependencyCycleEffectResolution';
/**
