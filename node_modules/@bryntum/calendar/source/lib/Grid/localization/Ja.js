...
const locale = {
    ...
    ChecklistFilterCombo : {
        ...
        selectAll   : 'すべて選択',
        removeAll   : 'すべて解除',
        filtersSet  : n => n === 1 ? `1 つのフィルターが設定されました` : `${n} つのフィルターが設定されました`,
        noItems     : '結果が見つかりません',
        placeholder : 'フィルター...',
        apply       : '適用'
    },
    ...
    ColumnPicker : {
        ...
        hideColumnShort : '非表示',
        newColumns      : '新しい列',
        showName        : column => `列${column.text ? ` ${column.text}` : ''} を表示`,
        hideName        : column => `列${column.text ? ` ${column.text}` : ''} を非表示`
    },
    ...
    Checkbox : {
        ...
        toggleName      : column => `切り替え ${column.text || '値'}`
    },
