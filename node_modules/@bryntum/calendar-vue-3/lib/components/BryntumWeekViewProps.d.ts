import type { ActionButtonsConfig, AlignSpec, Base, BryntumScrollOptions, ButtonConfig, CalendarMixin, CalendarRow, CalendarRowConfig, ContainerItemConfig, ContainerLayoutConfig, DayCell, DomConfig, DurationConfig, EventBar, EventModel, FluidDayLayoutConfig, KeyMapConfig, MaskConfig, MenuItemConfig, OverflowPopupConfig, PagingToolbarConfig, PanelCollapserConfig, PanelCollapserOverlayConfig, PanelHeader, Rectangle, ResourceModel, Scroller, ScrollerConfig, StateProvider, TabConfig, ToolConfig, ToolbarConfig, ToolbarItems, TooltipConfig, WeekViewListeners, Widget } from '@bryntum/calendar';
export declare type BryntumWeekViewProps = {
    /**
