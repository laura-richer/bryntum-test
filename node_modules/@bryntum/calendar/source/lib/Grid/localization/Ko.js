...
const locale = {
    ...
    ChecklistFilterCombo : {
        ...
        selectAll   : '전체 선택',
        removeAll   : '전체 해제',
        filtersSet  : n => n === 1 ? `1개의 필터 설정됨` : `${n}개의 필터 설정됨`,
        noItems     : '결과가 없습니다',
        placeholder : '필터...',
        apply       : '적용'
    },
    ...
    ColumnPicker : {
        ...
        hideColumnShort : '숨기기',
        newColumns      : '신규 열',
        showName        : column => `열${column.text ? ` ${column.text}` : ''} 표시`,
        hideName        : column => `열${column.text ? ` ${column.text}` : ''} 숨기기`
    },
    ...
    Checkbox : {
        ...
        toggleName      : column => `전환 ${column.text || '값'}`
    },
