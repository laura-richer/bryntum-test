...
const locale = {
    ...
    EmptyCalendarEffectDescription : {
        descriptionTpl               : '无法执行“ {2}”任务。 “ {0}”日历不提供任何工作时间间隔。',
        forwardDescriptionTpl        : '无法执行“ {2}”任务。 {1}之后的“ {0}”日历没有工作时间。',
        backwardDescriptionTpl       : '无法执行“ {2}”任务。 “ {0}”日历在{1}之前没有工作时间。',
        noIntersectionDescriptionTpl : '无法执行“ {2}”任务。它的“ {0}”日历及其资源日历没有共同的工作时间。'
    },
    ...
    IgnoreResourceCalendarEmptyCalendarEffectResolution : {
        descriptionTpl : '忽略资源日历，并仅使用自己的日历安排任务。'
    },
    ...
    PostponeDateConstraintConflictResolution : {
        descriptionTpl : '推迟解决并使用冲突标记标记任务 "{0}"'
    }
}
