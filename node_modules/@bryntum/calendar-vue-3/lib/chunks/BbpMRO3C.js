import { defineComponent as h, ref as i, provide as g, onMounted as f, getCurrentInstance as u, toRaw as b, watch as y, onBeforeUnmount as w, createElementBlock as S, openBlock as D } from "vue";
import { PagingToolbar as C } from "@bryntum/calendar";
...
const B = /* @__PURE__ */ h({
  ...
  setup(x, { expose: s, emit: c }) {
    ...
    }, o = {}, n = i(), r = i(/* @__PURE__ */ new Map());
    return g("teleports", r), f(() => {
      const e = u();
...
//# sourceMappingURL=BbpMRO3C.js.map
