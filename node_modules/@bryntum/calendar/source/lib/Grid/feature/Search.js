 ...
 * ```
 *
 * {@note}When Store has {@link Core.data.Store#config-lazyLoad}, this feature will only work on locally available data{/@note}
 *
 * @demo Grid/search
 *
...
export default class Search extends Delayable(InstancePlugin) {
    ...
    onTreeNodeExpand() {
        if (this.text) {
            this.requestAnimationFrame(this.search, [this.text, false, true, undefined, undefined, false]);
        }
    }
