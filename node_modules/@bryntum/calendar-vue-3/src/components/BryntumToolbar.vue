...
import type { AlignSpec, Base, ClickRepeaterConfig, Container, ContainerItemConfig, ContainerLayoutConfig, DomConfig, KeyMapConfig, MaskConfig, Model, Rectangle, Scroller, ScrollerConfig, TabConfig, ToolConfig, ToolbarItems, ToolbarListeners, TooltipConfig, VueConfig, Widget } from '@bryntum/calendar';
...
defineProps<{
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/calendar/docs/api/Core/widget/Toolbar#config-ariaLive)
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/calendar/docs/api/Core/widget/Toolbar#config-owner)
     */
    owner ? : Widget
    /**
