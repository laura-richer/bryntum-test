...
const locale = {
    ...
    EmptyCalendarEffectDescription : {
        descriptionTpl               : '"{2}" Opgave kan ikke udføres. "{0}" Kalender leverer ikke nogen arbejdstidsintervaller.',
        forwardDescriptionTpl        : '"{2}" opgave kan ikke udføres. "{0}" Kalender har ingen arbejdstid efter {1}.',
        backwardDescriptionTpl       : '"{2}" opgave kan ikke udføres. "{0}" Kalender har ingen arbejdstid før {1}.',
        noIntersectionDescriptionTpl : '"{2}" opgave kan ikke udføres. Dens "{0}" -kalender og dens ressourcekalendere har ingen fælles arbejdstid.'
    },
    ...
    IgnoreResourceCalendarEmptyCalendarEffectResolution : {
        descriptionTpl : 'Ignorer ressourcekalendere, og planlæg kun opgaven med sin egen kalender.'
    },
    ...
    PostponeDateConstraintConflictResolution : {
        descriptionTpl : 'Udsæt løsning og marker opgave "{0}" med konfliktmarkør'
    }
}
