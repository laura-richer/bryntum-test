...
export class AbstractPartOfProjectGenericMixin extends Mixin(
    ...
    class AbstractPartOfProjectGenericMixin extends base {
        // "Raw" suffix here to not interfere with the automatically added `isPartOfProject`
        // accessor for `PartOfProject` mixin, which is defined outside of engine however
        get isPartOfProjectRaw () : boolean {
            return true
        }
