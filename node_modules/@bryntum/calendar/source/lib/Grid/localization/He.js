...
const locale = {
    ...
    ChecklistFilterCombo : {
        ...
        selectAll   : 'בחר הכל',
        removeAll   : 'הסר הכל',
        filtersSet  : n => n === 1 ? `1 מסנן הוגדר` : `${n} מסננים הוגדרו`,
    ...
    ColumnPicker : {
        ...
        showName        : column => `הצג עמודה${column.text ? ` ${column.text}` : ''}`,
        hideName        : column => `הסתר עמודה${column.text ? ` ${column.text}` : ''}`
    },
    ...
    RowExpander : {
        ...
        expand            : 'הרחב',
        collapse          : 'מזער',
        columnDescription : 'החלף פרטי שורה'
    },
