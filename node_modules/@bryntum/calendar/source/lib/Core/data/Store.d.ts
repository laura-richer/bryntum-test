...
export default class Store extends Events(Base) {
    ...
    query(fn : (model : this['modelInstanceT']) => boolean, searchAllRecords? : boolean) : this['modelInstanceT'][]
    ...
    isAvailable (record : InstanceType<this[ 'modelClass' ]>) : boolean
    ...
    makeChained () : this
    chain (filterFn : (model : this['modelInstanceT']) => boolean) : this
    chain () : this
    ...
    suspendSortOnUpdate() : void
    resumeSortOnUpdate(sort? : boolean) : void
