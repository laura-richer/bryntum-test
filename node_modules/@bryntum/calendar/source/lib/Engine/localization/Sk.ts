...
const locale = {
    ...
    EmptyCalendarEffectDescription : {
        descriptionTpl               : 'Úlohu „{2}“ nie je možné vykonať. „{0}“ Kalendár neposkytuje žiadne pracovné časové intervaly.',
        forwardDescriptionTpl        : 'Úlohu „{2}“ nie je možné vykonať. „{0}“ Kalendár nemá pracovný čas po {1}.',
        backwardDescriptionTpl       : 'Úlohu „{2}“ nie je možné vykonať. Kalendár "{0}" Pred {1} nemá žiadny pracovný čas.',
        noIntersectionDescriptionTpl : 'Úlohu „{2}“ nie je možné vykonať. Jeho kalendár „{0}“ a kalendáre zdrojov nemajú spoločný pracovný čas.'
    },
    ...
    IgnoreResourceCalendarEmptyCalendarEffectResolution : {
        descriptionTpl : 'Ignorujte kalendáre zdrojov a naplánujte úlohu iba svojím vlastným kalendárom.'
    },
    ...
    PostponeDateConstraintConflictResolution : {
        descriptionTpl : 'Odložte riešenie a označte úlohu "{0}" značkou konfliktu'
    }
}
