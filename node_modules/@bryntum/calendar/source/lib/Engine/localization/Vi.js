...
const locale = {
    ...
    EmptyCalendarEffectDescription: {
        descriptionTpl: 'Tác vụ "{2}" không thể được thực hiện. "{0}" Lịch không cung cấp bất kỳ khoảng thời gian làm việc nào.',
        forwardDescriptionTpl: 'Tác vụ "{2}" không thể được thực hiện. "{0}" Lịch không có thời gian làm việc sau {1}.',
        backwardDescriptionTpl: 'Tác vụ "{2}" không thể được thực hiện. "{0}" Lịch không có thời gian làm việc trước {1}.',
        noIntersectionDescriptionTpl: 'Tác vụ "{2}" không thể được thực hiện. Lịch "{0}" của nó và lịch tài nguyên của nó không có thời gian làm việc chung.'
    },
    ...
    IgnoreResourceCalendarEmptyCalendarEffectResolution: {
        descriptionTpl: 'Bỏ qua lịch tài nguyên và chỉ lên lịch nhiệm vụ với lịch riêng.'
    },
    ...
    PostponeDateConstraintConflictResolution: {
        descriptionTpl: 'Trì hoãn việc giải quyết và gắn cờ tác vụ "{0}" bằng điểm đánh dấu xung đột'
    }
};
