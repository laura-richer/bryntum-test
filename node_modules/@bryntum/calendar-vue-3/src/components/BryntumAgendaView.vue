<!-- Vue 3 wrapper for Bryntum AgendaView -->
...
import type { AgendaViewListeners, AjaxStore, AjaxStoreConfig, Base, BryntumScrollOptions, Button, ButtonConfig, CalendarMixin, CellCopyPaste, CellCopyPasteConfig, CellEdit, CellEditConfig, CellMenu, CellMenuConfig, CellTooltip, CellTooltipConfig, Column, ColumnAutoWidth, ColumnAutoWidthConfig, ColumnDragToolbar, ColumnDragToolbarConfig, ColumnPicker, ColumnPickerConfig, ColumnRename, ColumnRenameConfig, ColumnReorder, ColumnReorderConfig, ColumnResize, ColumnResizeConfig, Container, ContainerItemConfig, DateRangeOwner, DayCell, DomConfig, DurationConfig, Editor, EventBar, EventModel, ExportConfig, Field, FileDrop, FileDropConfig, FillHandle, FillHandleConfig, Filter, FilterBar, FilterBarConfig, FilterConfig, FormulaProviderConfig, Grid, GridBase, GridExcelExporter, GridExcelExporterConfig, GridGroupSummary, GridGroupSummaryConfig, GridLocation, GridLocationConfig, GridLockRows, GridLockRowsConfig, GridPdfExport, GridPdfExportConfig, GridPrint, GridPrintConfig, GridRowReorder, GridRowReorderConfig, GridRowResize, GridRowResizeConfig, GridSelectionMode, GridSplit, GridSplitConfig, GridSummary, GridSummaryConfig, Group, GroupConfig, HeaderMenu, HeaderMenuConfig, KeyMapConfig, Mask, MaskConfig, Menu, MenuItem, MenuItemConfig, MergeCells, MergeCellsConfig, Model, ModelConfig, PagingToolbarConfig, Panel, PanelCollapserConfig, PanelCollapserOverlayConfig, PanelHeader, PreserveScrollOptions, QuickFind, QuickFindConfig, RangeMenuConfig, RecordPositionContext, RegionResize, RegionResizeConfig, ResourceModel, Row, RowCopyPaste, RowCopyPasteConfig, RowEdit, RowEditConfig, RowExpander, RowExpanderConfig, ScrollManager, ScrollManagerConfig, Scroller, ScrollerConfig, Search, SearchConfig, Sort, SortConfig, StateProvider, StickyCells, StickyCellsConfig, Store, StoreConfig, Stripe, StripeConfig, SubGrid, SubGridConfig, TabConfig, Tool, ToolConfig, ToolbarConfig, ToolbarItems, Tree, TreeConfig, TreeGroup, TreeGroupConfig, Widget, XLSColumn } from '@bryntum/calendar';
...
const emit = defineEmits<{
     ...
     * @param {object} params Event parameters
     * @param {object} params.event Event object
     * @param {Calendar.widget.AgendaView} params.event.source The triggering instance.
     */
    (e: 'refresh', params: ((event: { source: AgendaView }) => void)|string): void
    /**
     ...
     * @param {object} params Event parameters
     * @param {object} params.event Event object
     * @param {Date} params.event.date The date which is at the top of the view
     */
    (e: 'topDateChange', params: ((event: { date: Date }) => void)|string): void
    /**
...
onMounted(() => {
    ...
    instance.value = WrapperHelper.createWidget<typeof AgendaView>({
        me,
        widgetData,
        emit,
