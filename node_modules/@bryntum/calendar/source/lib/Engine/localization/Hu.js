...
const locale = {
    ...
    EmptyCalendarEffectDescription: {
        descriptionTpl: 'A "{2}" feladatot nem lehet elvégezni. A "{0}" naptár nem biztosítja a munkaidő -intervallumokat.',
        forwardDescriptionTpl: 'A "{2}" feladatot nem lehet elvégezni. "{0}" A naptárnak nincs munkaidő a {1} után.',
        backwardDescriptionTpl: 'A "{2}" feladatot nem lehet elvégezni. "{0}" A naptárnak nincs munkaidője a {1} előtt.',
        noIntersectionDescriptionTpl: 'A "{2}" feladatot nem lehet elvégezni. A "{0}" naptárának és erőforrásnaptárának nincs általános munkaidő.'
    },
    ...
    IgnoreResourceCalendarEmptyCalendarEffectResolution: {
        descriptionTpl: 'Ne hagyja figyelmen kívül az erőforrás -naptárakat, és csak a saját naptárával ütemezze be a feladatot.'
    },
    ...
    PostponeDateConstraintConflictResolution: {
        descriptionTpl: 'A megoldás elhalasztása és a(z) "{0}" feladat megjelölése ütközésjelzővel'
    }
};
