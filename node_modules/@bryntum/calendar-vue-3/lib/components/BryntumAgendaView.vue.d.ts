import type { AgendaViewListeners, AjaxStore, AjaxStoreConfig, Base, BryntumScrollOptions, Button, ButtonConfig, CalendarMixin, CellCopyPaste, CellCopyPasteConfig, CellEdit, CellEditConfig, CellMenu, CellMenuConfig, CellTooltip, CellTooltipConfig, Column, ColumnAutoWidth, ColumnAutoWidthConfig, ColumnDragToolbar, ColumnDragToolbarConfig, ColumnPicker, ColumnPickerConfig, ColumnRename, ColumnRenameConfig, ColumnReorder, ColumnReorderConfig, ColumnResize, ColumnResizeConfig, ContainerItemConfig, DayCell, DomConfig, DurationConfig, Editor, EventBar, EventModel, FileDrop, FileDropConfig, FillHandle, FillHandleConfig, Filter, FilterBar, FilterBarConfig, FilterConfig, FormulaProviderConfig, Grid, GridBase, GridExcelExporter, GridExcelExporterConfig, GridGroupSummary, GridGroupSummaryConfig, GridLocation, GridLockRows, GridLockRowsConfig, GridPdfExport, GridPdfExportConfig, GridPrint, GridPrintConfig, GridRowReorder, GridRowReorderConfig, GridRowResize, GridRowResizeConfig, GridSelectionMode, GridSplit, GridSplitConfig, GridSummary, GridSummaryConfig, Group, GroupConfig, HeaderMenu, HeaderMenuConfig, KeyMapConfig, Mask, MaskConfig, Menu, MenuItem, MenuItemConfig, MergeCells, MergeCellsConfig, Model, ModelConfig, PagingToolbarConfig, Panel, PanelCollapserConfig, PanelCollapserOverlayConfig, PanelHeader, PreserveScrollOptions, QuickFind, QuickFindConfig, RangeMenuConfig, RecordPositionContext, RegionResize, RegionResizeConfig, ResourceModel, Row, RowCopyPaste, RowCopyPasteConfig, RowEdit, RowEditConfig, RowExpander, RowExpanderConfig, ScrollManager, ScrollManagerConfig, Scroller, ScrollerConfig, Search, SearchConfig, Sort, SortConfig, StateProvider, StickyCells, StickyCellsConfig, Store, StoreConfig, Stripe, StripeConfig, SubGrid, SubGridConfig, TabConfig, Tool, ToolConfig, ToolbarConfig, ToolbarItems, Tree, TreeConfig, TreeGroup, TreeGroupConfig, Widget } from '@bryntum/calendar';
import { AgendaView } from '@bryntum/calendar';
declare const _default: import("vue").DefineComponent<__VLS_TypePropsToRuntimeProps<{
     ...
     */
    alwaysShowCurrentDate?: Boolean | undefined;
    /**
     ...
     */
    columns?: object | object[] | undefined;
     ...
     */
    dateFilter?: string | ((context: DayCell) => Boolean) | undefined;
    /**
     ...
     */
    eventListTimeFormat?: string | undefined;
    /**
     * A function, or the name of a function in the ownership hierarchy which you
     * can specify to customize event DOM content.
     * ...
     ...
     */
    eventRowSpacing?: string | number | undefined;
    /**
     ...
     */
    eventTimeRenderer?: string | ((eventRecord: EventModel, date: Date) => string | DomConfig | DomConfig[]) | undefined;
    /**
     ...
     */
    hideEventOverflow?: Boolean | undefined;
    /**
     ...
     */
    listeners?: AgendaViewListeners | undefined;
    /**
     ...
     */
    listRangeMenu?: RangeMenuConfig | null | undefined;
    /**
     ...
     */
    offsetStartsBeforeEvents?: Boolean | undefined;
    /**
     ...
     */
    settingsButton?: ButtonConfig | Button | undefined;
    /**
     ...
     */
    showEmptyDates?: Boolean | undefined;
    /**
    ...
    type?: "agendaview" | "agenda" | undefined;
    /**
    ...
    rangeChange: (params: string | ((event: {
        source: <T extends import("@bryntum/calendar").AnyConstructor<Base>>(base: T) => import("@bryntum/calendar").AnyConstructor<InstanceType<T> & import("@bryntum/calendar").DateRangeOwnerClass>;
        old: {
            startDate: Date;
            endDate: Date;
        };
    ...
    topDateChange: (params: string | ((event: {
        date: Date;
    }) => void)) => void;
    ...
    onGridRowDragStart?: ((params: any) => any) | undefined;
    ...
    onRangeChange?: ((params: string | ((event: {
        source: <T extends import("@bryntum/calendar").AnyConstructor<Base>>(base: T) => import("@bryntum/calendar").AnyConstructor<InstanceType<T> & import("@bryntum/calendar").DateRangeOwnerClass>;
        old: {
            startDate: Date;
            endDate: Date;
    ...
    onTopDateChange?: ((params: string | ((event: {
        date: Date;
    }) => void)) => any) | undefined;
