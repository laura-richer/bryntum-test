 ...
 * @mixin
 */
export default Target => class State extends (Target || Base).mixin(Events) {
    static $name = 'State';
     ...
     * @preventable
     * @param {Object} event The Bryntum event object
     * @param {Object} event.state State object config
     */

    /**
     * Fired before state is applied to the source. Allows editing the state object or preventing the operation.
     * @event beforeStateApply
     * @preventable
     * @param {Object} event The Bryntum event object
     * @param {Object} event.state State object config
     */
    ...
    set state(state) {
        ...
        if (state) {
            if (this.trigger('beforeStateApply', { state }) !== false) {
    ...
    getState() {
        const
            ...
            source      = defaultState ? Object.assign(Object.create(me.$meta.config), initialConfig) : me;
    ...
    saveState(options) {
        ...
        if (statefulId && stateProvider) {
            if (options.immediate) {
                ...
                const { state } = me;
                if (me.trigger('beforeStateSave', { state }) !== false) {
                    stateProvider.setValue(statefulId, state);
                }
            }
