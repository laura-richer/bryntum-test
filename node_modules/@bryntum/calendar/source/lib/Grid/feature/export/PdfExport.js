...
export default class PdfExport extends InstancePlugin {
    ...
    buildExportConfig(config = {}) {
        ...
        if (!(result.exporterType === 'multipagevertical' || result.exporterType === 'verticalmultipagevertical')) {
    ...
    get defaultExportDialogConfig() {
        ...
        return {
            ...
            useBrowserPrint : me.useBrowserPrint,
            items           : {
                rowsRangeField : {
                    value : me.rowsRange
                },
     ...
     */
    get isExporting() {
        return Boolean(this.client.isExporting);
    }
