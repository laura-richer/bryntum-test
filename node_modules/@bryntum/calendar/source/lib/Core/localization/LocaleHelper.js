 ...
 * @typings key -> {[key: string]}:{string|number|Function|LocaleKeys|object}
 */
...
export default class LocaleHelper {
     ...
     */
    static get locales() {
        return LocaleHelper.global.bryntum.locales || {};
    }

    static set locales(locales) {
        LocaleHelper.global.bryntum.locales = locales;
    }
    ...
    static get localeName() {
        return LocaleHelper.global.bryntum.locale || 'En';
    }

    static set localeName(localeName) {
        LocaleHelper.global.bryntum.locale = localeName || LocaleHelper.localeName;
    }
    ...
    static publishLocale(nameOrConfig, config) {
        const
            { locales }    = LocaleHelper.global.bryntum,
...
LocaleHelper.global.bryntum = LocaleHelper.global.bryntum || {};
LocaleHelper.global.bryntum.locales = LocaleHelper.global.bryntum.locales || {};
