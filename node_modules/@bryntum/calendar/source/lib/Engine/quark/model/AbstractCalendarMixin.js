    ...
    class CalendarMixin extends base {
        ...
        resetPriorityOfAllIntervals() {
            this.traverse((calendar) => {
                for (const interval of calendar.intervalStore)
        ...
        getDayIntervals(day) {
            const startDate = DateHelper.clearTime(day), endDate = DateHelper.getNext(day, TimeUnit.Day);
            let intervals = [];
            this.forEachAvailabilityInterval({ startDate, endDate, isForward: true }, (_intervalStartDate, _intervalEndDate, calendarCacheInterval) => intervals.push([_intervalStartDate, _intervalEndDate, calendarCacheInterval.intervals[0]]));
            return intervals;
        }
