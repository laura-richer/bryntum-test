...
const emit = defineEmits<{
     ...
     * @param {Core.widget.Widget} params.event.prevActiveItem The previously active view.
     * @param {Core.widget.Widget} params.event.activeItem The new active view.
     * @param {boolean} params.event.containedFocus `true` if the outgoing view contained focus.
     */
    (e: 'activeItemChange', params: ((event: { source: Calendar, prevActiveItem: Widget, activeItem: Widget, containedFocus: boolean }) => void)|string): void
    /**
     ...
     * @param {Core.widget.Widget} params.event.activeItem The new active view.
     */
    (e: 'beforeActiveItemChange', params: ((event: { source: Calendar, prevActiveItem: Widget, activeItem: Widget }) => Promise<boolean>|boolean|void)|string): Promise<boolean>|boolean|void
    /**
     ...
     * @param {typeof CalendarMixin} params.event.view The view in which the event is being created.
     */
     ...
     * @param {AgendaViewConfig,DayResourceViewConfig,DayViewConfig,EventListConfig,MonthViewConfig,ResourceViewConfig,WeekViewConfig,YearViewConfig} params.event.config The configuration block of the mode about to be created. Any property, including the `type` may be changed.
     * @param {string} params.event.config.type The type of the mode about to be created.
     */
    (e: 'beforeCreateMode', params: ((event: { source: Calendar, config: { type: string } }) => Promise<boolean>|boolean|void)|string): Promise<boolean>|boolean|void
    /**
     ...
     * @param {Core.widget.Widget} params.event.view The Calendar widget in which the drag is being started.
     */
    (e: 'beforeDragCreate', params: ((event: { source: Calendar, drag: DragContext, domEvent: Event, date: Date, resourceRecord?: ResourceModel, feature: CalendarDrag, view: Widget }) => Promise<boolean>|boolean|void)|string): Promise<boolean>|boolean|void
    /**
     ...
     * @param {Core.widget.Widget} params.event.view The Calendar widget in which the drag completed.
     */
    (e: 'beforeDragCreateEnd', params: ((event: { source: Calendar, drag: DragContext, event: Event, eventRecord: EventModel, newStartDate: Date, newEndDate: Date, resourceRecord?: ResourceModel, feature: CalendarDrag, validation: boolean|ValidateCreateResult, view: Widget }) => Promise<boolean>|boolean|void)|string): Promise<boolean>|boolean|void
    /**
     ...
     * @param {Core.widget.Widget} params.event.view The Calendar widget in which the drag is being started.
     */
    (e: 'beforeDragMove', params: ((event: { source: Calendar, drag: DragContext, domEvent: Event, eventRecord: EventModel, date: Date, resourceRecord?: ResourceModel, feature: CalendarDrag, view: Widget }) => Promise<boolean>|boolean|void)|string): Promise<boolean>|boolean|void
    /**
     ...
     * @param {Core.widget.Widget} params.event.view The Calendar widget in which the drag is being started.
     */
    (e: 'beforeDragResize', params: ((event: { source: Calendar, drag: DragContext, domEvent: Event, eventRecord: EventModel, date: Date, resourceRecord?: ResourceModel, feature: CalendarDrag, view: Widget }) => Promise<boolean>|boolean|void)|string): Promise<boolean>|boolean|void
    /**
     ...
     * @param {Core.widget.Widget} params.event.view The Calendar widget in which the drag completed.
     */
    (e: 'beforeDragResizeEnd', params: ((event: { source: Calendar, drag: DragContext, event: Event, eventRecord: EventModel, newStartDate: Date, newEndDate: Date, feature: CalendarDrag, validation: boolean|ValidateCreateResult, view: Widget }) => Promise<boolean>|boolean|void)|string): Promise<boolean>|boolean|void
    /**
     ...
     * @param {object} params Event parameters
     * @param {object} params.event Event object
     * @param {typeof CalendarMixin} params.event.source The view which triggered the event.
     * @param {Event} params.event.domEvent The initiating DOM event.
     * @param {Date} params.event.date The date clicked on.
     */
    (e: 'cellOverflowClick', params: ((event: { source: typeof CalendarMixin, domEvent: Event, date: Date }) => void)|string): void
    /**
     ...
     * @param {typeof CalendarMixin} params.event.view The view in which the event is being created.
     */
    (e: 'dayCellPopulated', params: ((event: { events: EventModel[], The: Date, view: typeof CalendarMixin }) => void)|string): void
    /**
     ...
     */
    (e: 'dayNumberClick', params: ((event: { source: typeof CalendarMixin, domEvent: Event, date: Date, cellData: DayCell, fromOverflowPopup: boolean }) => void)|string): void
    /**
     ...
     * @param {Core.widget.Widget} params.event.view The Calendar widget in which the drag completed.
     */
    (e: 'dragCreateEnd', params: ((event: { source: Calendar, drag: DragContext, event: Event, eventRecord: EventModel, resourceRecord?: ResourceModel, feature: CalendarDrag, validation: boolean|ValidateCreateResult, view: Widget }) => void)|string): void
    /**
     ...
     * @param {Core.widget.Widget} params.event.view The Calendar widget in which the drag completed.
     */
    (e: 'dragMoveEnd', params: ((event: { source: Calendar, drag: DragContext, event: Event, eventRecord: EventModel, resourceRecord?: ResourceModel, feature: CalendarDrag, validation: boolean|ValidateCreateResult, view: Widget }) => void)|string): void
    /**
     ...
     * @param {Core.widget.Widget} params.event.view The Calendar widget in which the drag completed.
     */
    (e: 'dragResizeEnd', params: ((event: { source: Calendar, drag: DragContext, event: Event, eventRecord: EventModel, feature: CalendarDrag, validation: boolean|ValidateCreateResult, view: Widget }) => void)|string): void
    /**
     ...
     * @param {object} params Event parameters
     * @param {object} params.event Event object
     * @param {typeof CalendarMixin} params.event.source The child view on which the event was initiated.
     ...
     * @param {boolean} params.event.fromOverflowPopup `true` if the interaction was through the source view's [overflowPopup](https://bryntum.com/products/calendar/docs/api/Calendar/widget/mixin/DayCellRenderer#property-overflowPopup).
     */
    (e: 'eventClick', params: ((event: { source: typeof CalendarMixin, domEvent: Event, date: Date, eventElement: HTMLElement, eventRecord: EventModel, resourceRecord: ResourceModel, fromOverflowPopup: boolean }) => void)|string): void
    /**
     ...
     * @param {boolean} params.event.fromOverflowPopup `true` if the interaction was through the source view's [overflowPopup](https://bryntum.com/products/calendar/docs/api/Calendar/widget/mixin/DayCellRenderer#property-overflowPopup).
     */
    (e: 'eventContextMenu', params: ((event: { source: typeof CalendarMixin, domEvent: Event, date: Date, eventElement: HTMLElement, eventRecord: EventModel, resourceRecord: ResourceModel, fromOverflowPopup: boolean }) => void)|string): void
    /**
     ...
     * @param {boolean} params.event.fromOverflowPopup `true` if the interaction was through the source view's [overflowPopup](https://bryntum.com/products/calendar/docs/api/Calendar/widget/mixin/DayCellRenderer#property-overflowPopup).
     */
    (e: 'eventDblClick', params: ((event: { source: typeof CalendarMixin, domEvent: Event, date: Date, eventElement: HTMLElement, eventRecord: EventModel, resourceRecord: ResourceModel, fromOverflowPopup: boolean }) => void)|string): void
    /**
     ...
     * @param {boolean} params.event.fromOverflowPopup `true` if the interaction was through the source view's [overflowPopup](https://bryntum.com/products/calendar/docs/api/Calendar/widget/mixin/DayCellRenderer#property-overflowPopup).
     */
    (e: 'eventKeyDown', params: ((event: { source: typeof CalendarMixin, domEvent: Event, date: Date, eventElement: HTMLElement, eventRecord: EventModel, resourceRecord: ResourceModel, fromOverflowPopup: boolean }) => void)|string): void
    /**
     ...
     * @param {boolean} params.event.fromOverflowPopup `true` if the interaction was through the source view's [overflowPopup](https://bryntum.com/products/calendar/docs/api/Calendar/widget/mixin/DayCellRenderer#property-overflowPopup).
     */
    (e: 'eventMouseDown', params: ((event: { source: typeof CalendarMixin, domEvent: Event, date: Date, eventElement: HTMLElement, eventRecord: EventModel, resourceRecord: ResourceModel, fromOverflowPopup: boolean }) => void)|string): void
    /**
     ...
     * @param {boolean} params.event.fromOverflowPopup `true` if the interaction was through the source view's [overflowPopup](https://bryntum.com/products/calendar/docs/api/Calendar/widget/mixin/DayCellRenderer#property-overflowPopup).
     */
    (e: 'eventMouseEnter', params: ((event: { source: typeof CalendarMixin, domEvent: Event, date: Date, eventElement: HTMLElement, eventRecord: EventModel, resourceRecord: ResourceModel, fromOverflowPopup: boolean }) => void)|string): void
    /**
     ...
     * @param {boolean} params.event.fromOverflowPopup `true` if the interaction was through the source view's [overflowPopup](https://bryntum.com/products/calendar/docs/api/Calendar/widget/mixin/DayCellRenderer#property-overflowPopup).
     */
    (e: 'eventMouseLeave', params: ((event: { source: typeof CalendarMixin, domEvent: Event, date: Date, eventElement: HTMLElement, eventRecord: EventModel, resourceRecord: ResourceModel, fromOverflowPopup: boolean }) => void)|string): void
    /**
     ...
     * @param {boolean} params.event.fromOverflowPopup `true` if the interaction was through the source view's [overflowPopup](https://bryntum.com/products/calendar/docs/api/Calendar/widget/mixin/DayCellRenderer#property-overflowPopup).
     */
    (e: 'eventMouseOut', params: ((event: { source: typeof CalendarMixin, domEvent: Event, date: Date, eventElement: HTMLElement, eventRecord: EventModel, resourceRecord: ResourceModel, fromOverflowPopup: boolean }) => void)|string): void
    /**
     ...
     * @param {boolean} params.event.fromOverflowPopup `true` if the interaction was through the source view's [overflowPopup](https://bryntum.com/products/calendar/docs/api/Calendar/widget/mixin/DayCellRenderer#property-overflowPopup).
     */
    (e: 'eventMouseOver', params: ((event: { source: typeof CalendarMixin, domEvent: Event, date: Date, eventElement: HTMLElement, eventRecord: EventModel, resourceRecord: ResourceModel, fromOverflowPopup: boolean }) => void)|string): void
    /**
     ...
     * @param {boolean} params.event.fromOverflowPopup `true` if the interaction was through the source view's [overflowPopup](https://bryntum.com/products/calendar/docs/api/Calendar/widget/mixin/DayCellRenderer#property-overflowPopup).
     */
    (e: 'eventMouseUp', params: ((event: { source: typeof CalendarMixin, domEvent: Event, date: Date, eventElement: HTMLElement, eventRecord: EventModel, resourceRecord: ResourceModel, fromOverflowPopup: boolean }) => void)|string): void
    /**
     ...
     */
    (e: 'monthNameClick', params: ((event: { source: typeof CalendarMixin, domEvent: Event, month: number, date: Date }) => void)|string): void
    /**
     ...
     * @param {object} params Event parameters
     * @param {object} params.event Event object
     * @param {typeof CalendarMixin} params.event.source The view which refreshed.
     */
    (e: 'refresh', params: ((event: { source: typeof CalendarMixin }) => void)|string): void
    /**
     ...
     */
    (e: 'scheduleClick', params: ((event: { source: typeof CalendarMixin, domEvent: Event, date: Date }) => void)|string): void
    /**
     ...
     * @param {Date} params.event.date The date clicked on. _Note that in a [DayView](https://bryntum.com/products/calendar/docs/api/Calendar/widget/DayView), this will include granular time information. For other views, this is the *start* of the date.
     */
    (e: 'scheduleContextMenu', params: ((event: { source: typeof CalendarMixin, domEvent: Event, date: Date }) => void)|string): void
    /**
     ...
     */
    (e: 'scheduleDblClick', params: ((event: { source: typeof CalendarMixin, domEvent: Event, date: Date }) => void)|string): void
    /**
     ...
     */
    (e: 'scheduleMouseDown', params: ((event: { source: typeof CalendarMixin, domEvent: Event, date: Date }) => void)|string): void
    /**
     ...
     */
    (e: 'scheduleMouseOut', params: ((event: { source: typeof CalendarMixin, domEvent: Event, date: Date }) => void)|string): void
    /**
     ...
     */
    (e: 'scheduleMouseOver', params: ((event: { source: typeof CalendarMixin, domEvent: Event, date: Date }) => void)|string): void
    /**
     ...
     */
    (e: 'scheduleMouseUp', params: ((event: { source: typeof CalendarMixin, domEvent: Event, date: Date }) => void)|string): void
    /**
     ...
     * @param {boolean} params.event.firstPaint `true` if this is the first paint
     */
    (e: 'viewPaint', params: ((event: { source: Widget, firstPaint: boolean }) => void)|string): void
    /**
     ...
     * @param {Date} params.event.date The date clicked on.
     */
    (e: 'weekNumberClick', params: ((event: { source: typeof CalendarMixin, domEvent: Event, week: number[], date: Date }) => void)|string): void
}>();
