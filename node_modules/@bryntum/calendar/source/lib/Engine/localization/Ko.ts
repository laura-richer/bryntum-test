...
const locale = {
    ...
    EmptyCalendarEffectDescription : {
        descriptionTpl               : '"{2}"작업을 수행 할 수 없습니다. "{0}"캘린더는 작업 시간 간격을 제공하지 않습니다.',
        forwardDescriptionTpl        : '"{2}"작업을 수행 할 수 없습니다. "{0}"캘린더에는 {1} 이후의 근무 시간이 없습니다.',
        backwardDescriptionTpl       : '"{2}"작업을 수행 할 수 없습니다. "{0}"캘린더에는 {1} 이전에 근무 시간이 없습니다.',
        noIntersectionDescriptionTpl : '"{2}"작업을 수행 할 수 없습니다. "{0}"캘린더와 리소스 캘린더에는 일반적인 근무 시간이 없습니다.'
    },
    ...
    IgnoreResourceCalendarEmptyCalendarEffectResolution : {
        descriptionTpl : '자원 캘린더를 무시하고 자체 캘린더로 만 작업을 예약하십시오.'
    },
    ...
    PostponeDateConstraintConflictResolution : {
        descriptionTpl : '해결을 연기하고 충돌 마커를 사용하여 작업 "{0}"에 플래그를 지정합니다.'
    }
}
