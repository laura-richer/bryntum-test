...
const locale = {
    ...
    EmptyCalendarEffectDescription : {
        descriptionTpl               : '"{2}" Задача не може да бъде изпълнена. "{0}" Календарът не предоставя никакви интервали от работно време.',
        forwardDescriptionTpl        : '"{2}" Задачата не може да бъде изпълнена. "{0}" Календарът няма работно време след {1}.',
        backwardDescriptionTpl       : '"{2}" Задачата не може да бъде изпълнена. "{0}" Календарът няма работно време преди {1}.',
        noIntersectionDescriptionTpl : '"{2}" Задачата не може да бъде изпълнена. Неговият календар "{0}" и неговите ресурсни календари нямат общо работно време.'
    },
    ...
    IgnoreResourceCalendarEmptyCalendarEffectResolution : {
        descriptionTpl : 'Игнорирайте календарите на ресурсите и планирайте задачата само със собствен календар.'
    },
    ...
    PostponeDateConstraintConflictResolution : {
        descriptionTpl : 'Отлагане на разрешаването и маркиране на задача "{0}" с маркер за конфликт'
    }
}
