 ...
 * <div class="b-colorbox b-inline b-sch-foreground-red"></div>red,
 * <div class="b-colorbox b-inline b-sch-foreground-pink"></div>pink,
 * <div class="b-colorbox b-inline b-sch-foreground-magenta"></div>magenta,
 * <div class="b-colorbox b-inline b-sch-foreground-purple"></div>purple,
 * <div class="b-colorbox b-inline b-sch-foreground-violet"></div>violet,
 * <div class="b-colorbox b-inline b-sch-foreground-deep-purple"></div>deep-purple,
 * <div class="b-colorbox b-inline b-sch-foreground-indigo"></div>indigo,
 * <div class="b-colorbox b-inline b-sch-foreground-blue"></div>blue,
 * <div class="b-colorbox b-inline b-sch-foreground-light-blue"></div>light-blue,
 * <div class="b-colorbox b-inline b-sch-foreground-cyan"></div>cyan,
 * <div class="b-colorbox b-inline b-sch-foreground-teal"></div>teal,
 * <div class="b-colorbox b-inline b-sch-foreground-green"></div>green,
 * <div class="b-colorbox b-inline b-sch-foreground-light-green"></div>light-green,
 * <div class="b-colorbox b-inline b-sch-foreground-gantt-green"></div>gantt-green
 * <div class="b-colorbox b-inline b-sch-foreground-lime"></div>lime,
 * <div class="b-colorbox b-inline b-sch-foreground-yellow"></div>yellow,
 * <div class="b-colorbox b-inline b-sch-foreground-orange"></div>orange,
 * <div class="b-colorbox b-inline b-sch-foreground-amber"></div>amber,
 * <div class="b-colorbox b-inline b-sch-foreground-deep-orange"></div>deep-orange
 * <div class="b-colorbox b-inline b-sch-foreground-light-gray"></div>light-gray
 * <div class="b-colorbox b-inline b-sch-foreground-gray"></div>gray
 * <div class="b-colorbox b-inline b-sch-foreground-black"></div>black
 * @typedef {'red'|'pink'|'magenta'|'purple'|'violet'|'deep-purple'|'indigo'|'blue'|'light-blue'|'cyan'|'teal'|'green'|'light-green'|'gantt-green'|'lime'|'yellow'|'orange'|'amber'|'deep-orange'|'light-gray'|'gray'|'black'|String|null} EventColor
 */
...
export default Target => class EventModelMixin extends Target {
     ...
     * @param {DurationUnitShort} unit The unit to shift by, see {@link Core.helper.DateHelper}
    ...
    applyResourceId(resourceId, fromApplyValue = false) {
        ...
        // avoid cycling
        if (me.isApplyingResourceId) {
            me.setData('resourceId', resourceId);
            return;
        }

        me.isApplyingResourceId = true;
    ...
    assign(resource, removeExistingAssignments = false) {
        ...
        if (eventStore && !eventStore.usesSingleAssignment) {
            return eventStore.assignEventToResource(this, resource, removeExistingAssignments);
        }
        else {
    ...
    isEditable(fieldName) {
        ...
        switch (fieldName) {
            ...
            case 'duration' :
            case 'fullDuration' :
                editable = this.isLeaf;
        }

        return editable && super.isEditable(fieldName);
    }
