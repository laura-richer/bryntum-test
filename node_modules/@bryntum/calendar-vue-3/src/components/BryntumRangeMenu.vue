<!-- Vue 3 wrapper for Bryntum RangeMenu -->
...
import type { AlignSpec, Base, Container, ContainerItemConfig, ContainerLayoutConfig, DomConfig, KeyMapConfig, MaskConfig, Menu, MenuItem, MenuItemConfig, Model, PagingToolbarConfig, Panel, PanelCollapserConfig, PanelCollapserOverlayConfig, PanelHeader, Popup, RangeMenuListeners, Rectangle, StateProvider, TabConfig, Tool, ToolConfig, ToolbarConfig, ToolbarItems, TooltipConfig, VueConfig, Widget } from '@bryntum/calendar';
import { RangeMenu } from '@bryntum/calendar';
...
onMounted(() => {
    ...
    instance.value = WrapperHelper.createWidget<typeof RangeMenu>({
        me,
        widgetData,
        emit,
