...
class LocaleManager extends Events(Base) {
    ...
    get localeCode() {
        return this.locale?.localeCode ?? 'en-US';
    }
    ...
    applyLocale(nameOrConfig, config, ignoreError = false) {
        ...
        localeConfig.oldLocaleName = me.locale.localeName;
        localeConfig.oldLocaleCode = me.locale.localeCode;
        ...
        const triggerLocaleEvent = () => {
             ...
             * @param {String} locale.oldLocaleName The name (eg, `'En") of the previous locale which was replaced.
             * @param {String} locale.oldLocaleCode The code (eg, `'en-US") of the previous locale which was replaced.
             */
