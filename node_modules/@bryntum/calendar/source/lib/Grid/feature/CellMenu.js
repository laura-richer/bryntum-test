 ...
 * ```
 *
 * <div class="note">The <code>processItems</code> implementation may be an <code>async</code> function which <code>awaits</code> a result to
 * mutate the <code>items</code> object.</div>
 *
...
export default class CellMenu extends ContextMenuBase {
     ...
     * @param {GridLocationConfig|Grid.util.GridLocation} cell The cell descriptor to show the menu for.
