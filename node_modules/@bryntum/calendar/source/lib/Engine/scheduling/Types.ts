...
} from "../quark/model/scheduler_pro/ConstrainedByDependenciesEventMixin.js"
 ...
 */
export enum StartedTaskScheduling {
    Auto       = "Auto",
    Manual     = "Manual"
}
...
export type EffectiveDirection = {
    ...
    kind        : 'enforced'
    direction   : Direction,
    enforcedBy  : ConstrainedByDependenciesEventMixin
} | {
    kind        : 'inherited'
    direction   : Direction,
    inheritedFrom : ConstrainedByDependenciesEventMixin
}
...
export enum TreatInconsistentIntervals {
    Skip    = 'Skip',
    Throw   = 'Throw'
}
