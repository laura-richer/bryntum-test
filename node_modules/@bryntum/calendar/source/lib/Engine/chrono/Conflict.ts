...
import { ConstrainedScheduleMixin } from "../quark/model/scheduler_pro/ConstrainedScheduleMixin.js"
...
export class ConflictEffectDescription extends Localizable(Base) {
    ...
    static $name = 'ConflictEffectDescription'
...
export class ConflictEffect extends SchedulingIssueEffect<ConflictResolution> {
    ...
    sourceSchedule              : ConstrainedScheduleMixin
    ...
    getResolutions () : ConflictResolution[] {
        if (!this._resolutions) {
            ...
            this._resolutions = this.intervals.flatMap(interval => interval.getResolutions(this.intervals, this))
        }
    ...
    filterConflictingIntervals (intervals : ConstraintInterval[]) : ConstraintInterval[] {
        ...
        const result : ConstraintInterval[] = []
        ...
        if (affectedInterval) {
            ...
            const sorted                = [ affectedInterval, ...intervalsArray.filter(a => a !== affectedInterval) ]
...
export class ConstraintIntervalDescription extends Localizable(Base) {
    ...
    static $name = 'ConstraintIntervalDescription'
    ...
    static getDescriptionParameters (interval : ConstraintInterval) : any[] {
        // resolve a reflection to its original interval to show not mapped but real dates
