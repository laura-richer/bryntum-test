...
export const IntervalSorterFn = (interval1 : CalendarIntervalMixin, interval2 : CalendarIntervalMixin) => {
    const priority1 = interval1.getPrioritySortValue()
    const priority2 = interval2.getPrioritySortValue()
...
export class CalendarCacheInterval {
    ...
    constructor (config? : Partial<CalendarCacheInterval>) {
        ...
        this.intervals = this.normalizeIntervals(this.intervals)
    ...
    getIsWorking () : boolean {
        ...
        return this.isWorking = this.intervals[ 0 ].isWorking
    }
    ...
    normalizeIntervals (intervals : CalendarIntervalMixin[]) : CalendarIntervalMixin[] {
        ...
        filtered.sort(IntervalSorterFn)
