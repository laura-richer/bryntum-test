...
const locale = {
    ...
    EmptyCalendarEffectDescription : {
        descriptionTpl               : '"{2}" -oppgaven kan ikke utføres. "{0}" -kalenderen gir ingen arbeidstidsintervaller.',
        forwardDescriptionTpl        : '"{2}" -oppgaven kan ikke utføres. "{0}" -kalender har ingen arbeidstid etter {1}.',
        backwardDescriptionTpl       : '"{2}" -oppgaven kan ikke utføres. "{0}" -kalender har ingen arbeidstid før {1}.',
        noIntersectionDescriptionTpl : '"{2}" -oppgaven kan ikke utføres. Dets "{0}" -kalender og ressurskalendere har ingen felles arbeidstid.'
    },
    ...
    IgnoreResourceCalendarEmptyCalendarEffectResolution : {
        descriptionTpl : 'Ignorer ressurskalendere og planlegge oppgaven bare med sin egen kalender.'
    },
    ...
    PostponeDateConstraintConflictResolution : {
        descriptionTpl : 'Utsett løsning og flagg oppgave "{0}" med konfliktmarkør'
    }
}
