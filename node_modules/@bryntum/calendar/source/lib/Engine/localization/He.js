...
const locale = {
    ...
    EmptyCalendarEffectDescription: {
        descriptionTpl: 'לא ניתן לבצע משימה "{2}". לוח השנה "{0}" אינו מספק מרווחי זמן עבודה.',
        forwardDescriptionTpl: 'לא ניתן לבצע משימה "{2}". "{0}" לוח השנה אין זמן עבודה לאחר {1}.',
        backwardDescriptionTpl: 'לא ניתן לבצע משימה "{2}". "{0}" לוח השנה אין זמן עבודה לפני {1}.',
        noIntersectionDescriptionTpl: 'לא ניתן לבצע משימה "{2}". לוח השנה "{0}" שלו וליומני המשאבים שלו אין זמן עבודה משותף.'
    },
    ...
    IgnoreResourceCalendarEmptyCalendarEffectResolution: {
        descriptionTpl: 'התעלם מלוחות יומרים של משאבים ותזמן את המשימה בלוח השנה שלה בלבד.'
    },
    ...
    PostponeDateConstraintConflictResolution: {
        descriptionTpl: 'דחה פתרון וסמן משימה "{0}" עם סמן התנגשות'
    }
};
