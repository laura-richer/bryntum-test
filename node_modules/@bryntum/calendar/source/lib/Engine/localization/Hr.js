...
const locale = {
    ...
    EmptyCalendarEffectDescription: {
        descriptionTpl: 'Zadatak "{2}" ne može se izvršiti. "{0}" kalendar ne pruža nijedan radno vrijeme.',
        forwardDescriptionTpl: 'Zadatak "{2}" ne može se izvršiti. "{0}" Kalendar nema radnog vremena nakon {1}.',
        backwardDescriptionTpl: 'Zadatak "{2}" ne može se izvršiti. "{0}" Kalendar nema radno vrijeme prije {1}.',
        noIntersectionDescriptionTpl: 'Zadatak "{2}" ne može se izvršiti. Njegov kalendar "{0}" i kalendari resursa nemaju uobičajeno radno vrijeme.'
    },
    ...
    IgnoreResourceCalendarEmptyCalendarEffectResolution: {
        descriptionTpl: 'Zanemarite kalendare resursa i zakažite zadatak samo vlastitim kalendarom.'
    },
    ...
    PostponeDateConstraintConflictResolution: {
        descriptionTpl: 'Odgodi rješavanje i označi zadatak "{0}" oznakom sukoba'
    }
};
