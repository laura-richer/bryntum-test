...
/**
 * A class implementing a dialog to edit a {@link Scheduler.model.RecurrenceModel}. The class is used by
 * the {@link Scheduler.view.mixin.RecurringEvents} feature, and you normally don't need to instantiate
 * it.
 *
 * Before showing the dialog, you need to use {@link Core.widget.Container#property-record} to load a
...
export default class RecurrenceEditor extends Popup {
    ...
    static $name = 'RecurrenceEditor';

    // Factoryable type name
    static type = 'recurrenceeditor';
        ...
        return {
            ...
            items     : {
                recurrenceEditorPanel : {
                    ...
                    items : {
                        monthDaysNumberRadioField : false
                    },
                    title : null
                }
            },
