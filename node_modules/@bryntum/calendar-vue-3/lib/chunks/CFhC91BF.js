import { defineComponent as h, ref as i, provide as u, onMounted as b, getCurrentInstance as f, toRaw as y, watch as g, onBeforeUnmount as S, createElementBlock as C, openBlock as x } from "vue";
import { CheckboxGroup as v } from "@bryntum/calendar";
...
const B = /* @__PURE__ */ h({
  ...
  setup(w, { expose: s, emit: c }) {
    ...
    }, o = {}, a = i(), l = i(/* @__PURE__ */ new Map());
    return u("teleports", l), b(() => {
      const e = f();
...
//# sourceMappingURL=CFhC91BF.js.map
